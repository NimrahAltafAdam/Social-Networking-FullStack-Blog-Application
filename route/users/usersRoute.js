...
userRoutes.put(
  "/profilephoto-upload", 
  authMiddleware, //will check whether the file is uploaded or not
  photoUpload.single('image'), //will pass the incoming request as form data
  profilePhotoResize,
  profilePhotoUploadCtrl);//NEXT STEP is to upload the files on clodinary create a file cloudinary.js in utils 
